...
{ (void)dev; pc386_panic("hal_storage_init not yet implemented (3f)"); }

size_t hal_storage_block_size(hal_storage_dev_t dev)
{ (void)dev; pc386_panic("hal_storage_block_size not yet implemented (3f)"); }

size_t hal_storage_block_count(hal_storage_dev_t dev)
{ (void)dev; pc386_panic("hal_storage_block_count not yet implemented (3f)"); }
