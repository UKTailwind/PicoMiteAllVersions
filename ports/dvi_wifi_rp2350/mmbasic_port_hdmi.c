/*
 * ports/dvi_wifi_rp2350/mmbasic_port_hdmi.c — HDMI build of shared
 * MMBasic.c port hooks. Identical body to
 * ports/hdmi_rp2350/mmbasic_port_hdmi.c (the WiFi flag doesn't change
 * the prompt-font selection rules). Replaces
 * ports/pico_sdk_common/mmbasic_port_pico.c at source-selection time.
 *
