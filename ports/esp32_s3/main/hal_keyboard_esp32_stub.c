...
int hal_keyboard_keydown_slot(int s) {
    (void)s;
    return 0;
}
...
int hal_keyboard_set_layout(int l) {
    (void)l;
    return 0;
}
void hal_keyboard_quiesce_for_reset(void) {}
int hal_keyboard_usb_raw_report(int s, unsigned char * o, int m) {
    (void)s;
    (void)o;
    (void)m;
    return 0;
...
void hal_keyboard_on_gpio_edge(uint32_t g) {
    (void)g;
}
