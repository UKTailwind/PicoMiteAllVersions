 ...
 */
int goodix_i2c_read(struct i2c_client *client, uint16_t reg, uint8_t *buf, int len)
{
	int ret;
	return ret;
}
 ...
 * @len: length of the buffer to write
 */
int goodix_i2c_write(struct i2c_client *client, uint16_t reg, const uint8_t *buf, int len)
{
	int ret;
	return ret;
}

int goodix_i2c_write_u8(struct i2c_client *client, uint16_t reg, uint8_t value)
{
...
static int goodix_ts_read_input_report(struct goodix_ts_data *ts, uint8_t *data)
{
	unsigned long max_timeout;
	int touch_num;
	int error;
	uint16_t addr = GOODIX_READ_COOR_ADDR;
	/*
...
static void goodix_ts_report_pen_down(struct goodix_ts_data *ts, uint8_t *data)
{
...
static void goodix_ts_report_touch_8b(struct goodix_ts_data *ts, uint8_t *coor_data)
{
...
static void goodix_ts_report_touch_9b(struct goodix_ts_data *ts, uint8_t *coor_data)
{
...
static void goodix_ts_report_key(struct goodix_ts_data *ts, uint8_t *data)
{
	int touch_num;
	uint8_t key_value;
	int i;
...
{
	uint8_t  point_data[2 + GOODIX_MAX_CONTACT_SIZE * GOODIX_MAX_CONTACTS];
	int touch_num;
	int i;
...
static int goodix_check_cfg_8(struct goodix_ts_data *ts, const uint8_t *cfg, int len)
{
...
static int goodix_check_cfg_16(struct goodix_ts_data *ts, const uint8_t *cfg,
			       int len)
{
 ...
 */
static int goodix_check_cfg(struct goodix_ts_data *ts, const uint8_t *cfg, int len)
{
 ...
 * @len: config data length
 */
int goodix_send_cfg(struct goodix_ts_data *ts, const uint8_t *cfg, int len)
{
	int error;
