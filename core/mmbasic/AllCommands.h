...
*/
    ...
    HAL_PORT_BACKLIGHT_PIC_CMD_TOKEN
        HAL_PORT_WIFI_OR_3D_CMD_TOKENS
            HAL_PORT_USB_OR_FIRMWARE_CMD_TOKEN{(unsigned char *)"Configure", T_CMD, 0, cmd_configure},
...
#endif
    HAL_PORT_RAM_CMD_TOKEN{(unsigned char *)"Bit(", T_CMD | T_FUN, 0, cmd_bit},
