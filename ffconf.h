 ...
 * host_native/port_config.h caps HAL_PORT_FILES_MAX at 128 (36 KB peak at
 * FF_MAX_LFN=255). Device ports (1000 slots) stay at FF_MAX_LFN=63 since
 * they serve real FAT filesystems where 8.3-ish paths are the norm. */
