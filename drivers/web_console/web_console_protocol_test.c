...
static void test_frames(void) {
    ...
    const uint8_t want_cmds[] = {
        'C', 'M', 'D', 'S', 0x40, 0x01, 0xf0, 0x00,
        WEB_CONSOLE_OP_CLS, 0x33, 0x22, 0x11, 0x00,
    };
...
static void test_commands(void) {
    ...
    const uint8_t want_pixel[] = {
        WEB_CONSOLE_OP_PIXEL, 0xff, 0xff, 0x02, 0x00,
        0x03, 0x02, 0x01, 0x00,
    };
    ...
    const uint8_t want_blit[] = {
        WEB_CONSOLE_OP_BLIT, 0x07, 0x00, 0x08, 0x00,
        0x01, 0x00, 0x01, 0x00, 0x01, 0x02, 0x03, 0xff,
    };
