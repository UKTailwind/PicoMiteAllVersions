...
| smokes | `porttools/device_datetime_smoke.py` (Pico+ESP32), `ports/host_native/tests/t194_datetime_funs.bas` (host), `ports/mmbasic_stdio/tests/09_datetime.bas` (stdio) |
